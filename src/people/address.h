...
public:
    ...
    Q_REQUIRED_RESULT QString city() const;
    ...
    Q_REQUIRED_RESULT QString countryCode() const;
    ...
    Q_REQUIRED_RESULT QString poBox() const;
    ...
    Q_REQUIRED_RESULT QString extendedAddress() const;
    ...
    /** The street address. **/
    Q_REQUIRED_RESULT QString streetAddress() const;
