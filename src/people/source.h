...
public:
    ...
    Q_REQUIRED_RESULT static Source fromJSON(const QJsonObject &);
    ...
    Q_REQUIRED_RESULT ProfileMetadata profileMetadata() const;
    ...
    Q_REQUIRED_RESULT QString updateTime() const;
