...
private Q_SLOTS:
    ...
    void testModify_data()
    {
        ...
        QTest::newRow("simple group") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(QFINDTESTDATA("data/contacts_group1_modify_request.txt"),
        ...
        QTest::newRow("batch modify") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(QFINDTESTDATA("data/contacts_group1_modify_request.txt"),
                                                                                                    QFINDTESTDATA("data/contacts_group1_modify_response.txt")),
