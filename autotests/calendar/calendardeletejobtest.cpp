...
private Q_SLOTS:
    ...
    void testDelete_data()
    {
        ...
        QTest::newRow("simple calendar") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(QFINDTESTDATA("data/calendar1_delete_request.txt"),
                                                                                                       QFINDTESTDATA("data/calendar1_delete_response.txt"))}
                                         << CalendarsList{calendarFromFile(QFINDTESTDATA("data/calendar1.json"))} << false;

        QTest::newRow("simple calendar (uid)") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(
            QFINDTESTDATA("data/calendar1_delete_request.txt"),
            QFINDTESTDATA("data/calendar1_delete_response.txt"))}
                                               << CalendarsList{calendarFromFile(QFINDTESTDATA("data/calendar1.json"))} << true;

        QTest::newRow("batch delete") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(QFINDTESTDATA("data/calendar1_delete_request.txt"),
                                                                                                    QFINDTESTDATA("data/calendar1_delete_response.txt")),
        ...
        QTest::newRow("batch delete (uid)") << QList<FakeNetworkAccessManager::Scenario>{scenarioFromFile(QFINDTESTDATA("data/calendar1_delete_request.txt"),
                                                                                                          QFINDTESTDATA("data/calendar1_delete_response.txt")),
                                                                                         scenarioFromFile(QFINDTESTDATA("data/calendar2_delete_request.txt"),
                                                                                                          QFINDTESTDATA("data/calendar2_delete_response.txt"))}
                                            << CalendarsList{calendarFromFile(QFINDTESTDATA("data/calendar1.json")),
